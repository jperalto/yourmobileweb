...
class MobilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mobile" do
    assert_difference('Mobile.count') do
      post mobiles_url, params: { mobile: { imagen: @mobile.imagen, marca_id: @mobile.marca_id, modelo_id: @mobile.modelo_id, precio: @mobile.precio, stock: @mobile.stock } }
    end
  ...
  test "should update mobile" do
    patch mobile_url(@mobile), params: { mobile: { imagen: @mobile.imagen, marca_id: @mobile.marca_id, modelo_id: @mobile.modelo_id, precio: @mobile.precio, stock: @mobile.stock } }
